...
Rcpp::List draw_theta_cpp_test(
  ...
  return Rcpp::List::create(Rcpp::Named("gamma_prop") = gamma_prop,
                            Rcpp::Named("phi_prop") = phi_prop,
                            Rcpp::Named("sigma2_prop") = sigma2_prop,
                            Rcpp::Named("chol11") = chol11,
                            Rcpp::Named("chol12") = chol12,
                            Rcpp::Named("chol22") = chol22,
                            Rcpp::Named("BT11") = BT11,
                            Rcpp::Named("BT12") = BT12,
                            Rcpp::Named("BT22") = BT22,
                            Rcpp::Named("bT1") = bT1,
                            Rcpp::Named("bT2") = bT2,
                            Rcpp::Named("cT") = cT,
                            Rcpp::Named("CT") = CT
